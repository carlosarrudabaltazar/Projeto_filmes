...
{
	private static final String pega_cod_filme = "SELECT MAX(A04_ID) AS ID FROM A04_FILMES;";
	...
	private static final String pega_cod_local_filme = "SELECT MAX(A06_ID) AS ID FROM A06_LOCAL_FILME;";
	...
	private static final String pega_cod_disqueteira = "SELECT MAX(A02_ID) AS ID FROM A02_DISQUETEIRA;";
	...
	private static final String pega_cod_genero_filme = "SELECT MAX(A05_ID) AS ID FROM A05_GENERO_FILME;";
	...
	private static final String pega_cod_local = "SELECT MAX(A03_ID) AS ID FROM A03_LOCAL;";
