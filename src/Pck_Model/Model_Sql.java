...
public class Model_Sql 
{
	...
	private static final String consulta_titulo = "SELECT FILMES.A04_TITULO AS TITULO, FILMES.A04_SUBTITULO AS SUBTITULO, GEN.A01_GENERO AS GENERO, DISQUE.A02_DISQUETEIRA AS DISQUETEIRA, LOCAL.A03_PAG AS PAGINA, LOCAL.A03_CASELA AS CASELA FROM A01_GENERO GEN, A02_DISQUETEIRA DISQUE, A03_LOCAL LOCAL, A04_FILMES FILMES, A05_GENERO_FILME GENF, A06_LOCAL_FILME LOCALF WHERE DISQUE.A02_ID = LOCAL.A02_ID AND GENF.A01_ID = GEN.A01_ID AND GENF.A04_ID = FILMES.A04_ID AND LOCALF.A04_ID = FILMES.A04_ID AND LOCALF.A03_ID = LOCAL.A03_ID AND FILMES.A04_TITULO LIKE ?;";
	private static final String consulta_subtitulo = "SELECT FILMES.A04_TITULO AS TITULO, FILMES.A04_SUBTITULO AS SUBTITULO, GEN.A01_GENERO AS GENERO, DISQUE.A02_DISQUETEIRA AS DISQUETEIRA, LOCAL.A03_PAG AS PAGINA, LOCAL.A03_CASELA AS CASELA FROM A01_GENERO GEN, A02_DISQUETEIRA DISQUE, A03_LOCAL LOCAL, A04_FILMES FILMES, A05_GENERO_FILME GENF, A06_LOCAL_FILME LOCALF WHERE DISQUE.A02_ID = LOCAL.A02_ID AND GENF.A01_ID = GEN.A01_ID AND GENF.A04_ID = FILMES.A04_ID AND LOCALF.A04_ID = FILMES.A04_ID AND LOCALF.A03_ID = LOCAL.A03_ID AND FILMES.A04_SUBTITULO LIKE ?;";
